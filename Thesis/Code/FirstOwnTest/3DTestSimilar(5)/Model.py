...
# read the data
circleX = reader.ReadData("circleCWDown500LocalPos.txt")    # cat 1
cloudX = reader.ReadData("cloudCW500LocalPos.txt")          # cat 2
heartX = reader.ReadData("heart500LocalPos.txt")            # cat 3
pentagonX = reader.ReadData("pentagonCW500LocalPos.txt")    # cat 4
realOtherX = reader.ReadData("other500LocalPos.txt")


readData = [circleX, cloudX, heartX, pentagonX]
