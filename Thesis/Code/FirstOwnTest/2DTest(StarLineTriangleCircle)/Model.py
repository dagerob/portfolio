...
lineX = reader.ReadData("line500.txt")          # cat 2
triangleX = reader.ReadData("triangle500.txt")  # cat 3
starX = reader.ReadData("star500.txt")          # cat 4

readData = [circleX, lineX, triangleX, starX]
mixedX = generate_random_shapes(readData)       # cat 0
